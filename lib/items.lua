...
Items.all = {
  ...
  { key="trainer_beacon", itemId="DS_TRAINER_BEACON", name="TRAINER BEACON", ownership="CONSUMABLE", family="SILPH_CO", effectKind="TRAINER", effect="DS_TRAINER_BEACON_EFFECT", implemented=true },
  { key="prototype_ball", itemId="DS_PROTOTYPE_BALL", name="PROTO BALL", ownership="CONSUMABLE", family="SILPH_CO", effectKind="CAPTURE", effect="DS_PROTOTYPE_BALL_EFFECT", implemented=true },
  { key="exp_battery", itemId="DS_EXP_BATTERY", name="EXP BATTERY", ownership="CONSUMABLE", family="SILPH_CO", effectKind="BATTLE", effect="DS_EXP_BATTERY_EFFECT", implemented=true },
  { key="link_cable", itemId="DS_LINK_CABLE", name="LINK CABLE", ownership="CONSUMABLE", family="SILPH_CO", effectKind="POKEMON", effect="DS_LINK_CABLE_EFFECT", implemented=true },
  ...
  { key="move_recorder", itemId="DS_MOVE_RECORDER", name="MOVE RECORDER", ownership="CONSUMABLE", family="CINNABAR_LAB", effectKind="POKEMON", effect="DS_MOVE_RECORDER_EFFECT", implemented=true },
  { key="fossil_catalyst", itemId="DS_FOSSIL_CATALYST", name="FOSSIL CAT.", ownership="CONSUMABLE", family="CINNABAR_LAB", effectKind="POKEMON", effect="DS_FOSSIL_CATALYST_EFFECT", implemented=true },
  { key="dna_stabilizer", itemId="DS_DNA_STABILIZER", name="DNA STABILIZER", ownership="CONSUMABLE", family="CINNABAR_LAB", effectKind="POKEMON", effect="DS_DNA_STABILIZER_EFFECT", implemented=true },
  { key="mutation_capsule", itemId="DS_MUTATION_CAPSULE", name="MUTATE CAP.", ownership="CONSUMABLE", family="CINNABAR_LAB", effectKind="POKEMON", effect="DS_MUTATION_CAPSULE_EFFECT", implemented=true },
