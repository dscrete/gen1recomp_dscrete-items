...
Incidents.OPERATIVES = {
  ronnie = {
    name = "RONNIE",
    tagline = "Talks first. Thinks later.",
  },
  milo = {
    name = "MILO",
    tagline = "Rocket's least enthusiastic employee.",
  },
  cass = {
    name = "CASS",
    tagline = "Competent enough to be dangerous.",
  },
}
...
local function cacheBox(env)
  if env:phase()=="reward" then
    ...
    local c=env:choose("HIDDEN CACHE",{
...
Incidents.ALL = {
    ...
    locations={
      {
        ...
        regionMaps={"VIRIDIAN_FOREST","VIRIDIAN_FOREST_NORTH_GATE","VIRIDIAN_FOREST_SOUTH_GATE"},
        anchor={x=16,y=43},
      },
    },
    transmissions={
  ...
  illegal_experiment = {
    id="illegal_experiment",
    title="ILLEGAL EXPERIMENT",
    operative="cass",
    expiry=3000,
    prototypePool={"prism_scent","elusive_scent","mystery_lure","species_whistle","prototype_resonator","glitch_detector"},
    locations={
      {
        ...
        regionMaps={"ROCK_TUNNEL_1F","ROUTE_9","ROUTE_10"},
        anchor={x=15,y=4},
      },
    },
    transmissions={
    ...
    actors={
      ...
      {role="scientist",name="DS_ROCKET_SCIENTIST",sprite="SPRITE_SCIENTIST",text="TEXT_DS_ROCKET_EXPERIMENT_SCI",dx=2,dy=0,phases={active=true}},
